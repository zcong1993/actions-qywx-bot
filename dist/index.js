...
const qiyeweixin_bot_1 = __webpack_require__(360);
...
async function run() {
    ...
    try {
        ...
        const bot = new qiyeweixin_bot_1.Bot({ key });
        try {
...
var iterate    = __webpack_require__(197)
  , initState  = __webpack_require__(965)
  , terminator = __webpack_require__(748)
  ;
...
const axios_1 = __webpack_require__(416);
...
class Bot {
    ...
    async sendImageMsg(msg) {
        return this.send(msg);
    }
    async sendNewsMsg(msg) {
        return this.send(msg);
    }
    async sendFileMsg(msg) {
        return this.send(msg);
    }
    async sendImageFile(filePath) {
        await util_1.ensureFileSizeLess(filePath, 2 << 20);
        const f = await fs_1.promises.readFile(filePath);
        const msg = {
            msgtype: 'image',
            image: {
                md5: util_1.md5(f),
                base64: util_1.toBase64(f),
            },
        };
    ...
    async uploadMedia(filePath, filename) {
        await util_1.ensureFileSizeLess(filePath, 20 << 20);
        const form = new FormData();
        const f = fs_1.createReadStream(filePath);
        let name;
        if (filename) {
            name = filename;
        }
        ...
        if (data.errcode !== 0) {
            throw new types_1.ApiError(data.errmsg);
        }
...
exports.humanize = __webpack_require__(382);
...
var defer = __webpack_require__(126);
...
var utils = __webpack_require__(426);
var settle = __webpack_require__(974);
var buildURL = __webpack_require__(472);
var buildFullPath = __webpack_require__(601);
var parseHeaders = __webpack_require__(701);
var isURLSameOrigin = __webpack_require__(779);
...
var mergeConfig = __webpack_require__(160);
...
axios.CancelToken = __webpack_require__(520);
axios.isCancel = __webpack_require__(559);
...
var enhanceError = __webpack_require__(499);
...
var utils = __webpack_require__(426);
var normalizeHeaderName = __webpack_require__(609);
...
function getDefaultAdapter() {
  ...
  if (typeof XMLHttpRequest !== 'undefined') {
    ...
    adapter = __webpack_require__(733);
  }
  return adapter;
}
...
try {
  var supportsColor = __webpack_require__(809);
...
var dispatchRequest = __webpack_require__(712);
var mergeConfig = __webpack_require__(160);
...
module.exports =
{
  parallel      : __webpack_require__(165),
  serial        : __webpack_require__(914),
...
var db = __webpack_require__(386)
...
var util = __webpack_require__(669);
var Stream = __webpack_require__(413).Stream;
var DelayedStream = __webpack_require__(79);
...
var isCancel = __webpack_require__(559);
var defaults = __webpack_require__(317);
...
var httpFollow = __webpack_require__(936).http;
var httpsFollow = __webpack_require__(936).https;
var url = __webpack_require__(835);
var zlib = __webpack_require__(761);
var pkg = __webpack_require__(563);
var createError = __webpack_require__(306);
var enhanceError = __webpack_require__(499);
...
var abort = __webpack_require__(723)
...
const hasFlag = __webpack_require__(217);
...
Object.defineProperty(exports, "__esModule", { value: true });
const command_1 = __webpack_require__(480);
const os = __importStar(__webpack_require__(87));
...
var serialOrdered = __webpack_require__(99);
...
var CombinedStream = __webpack_require__(619);
var util = __webpack_require__(669);
...
var mime = __webpack_require__(538);
var asynckit = __webpack_require__(434);
var populate = __webpack_require__(658);
...
var debug = __webpack_require__(271)("follow-redirects");
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.ensureFileSizeLess = exports.fileSize = exports.toBase64 = exports.md5 = void 0;
const fs_1 = __webpack_require__(747);
...
exports.toBase64 = (bf) => bf.toString('base64');
exports.fileSize = async (path) => {
    const { size } = await fs_1.promises.stat(path);
    return size;
};
exports.ensureFileSizeLess = async (path, maxSize) => {
    const size = await exports.fileSize(path);
    if (size > maxSize) {
